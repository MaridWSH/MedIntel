          ...
          <div className="mt-16 max-w-[700px] mx-auto">
            ...
            <div className="space-y-0 divide-y divide-ink/8">
              {[
                ...
                {
                  q: 'Are CME credits included in all plans?',
                  a: 'CME credits (0.5h per paper) are available on Professional and Research Pro plans. Free tier users can view content but cannot claim credits.',
                },
                {
